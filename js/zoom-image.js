...
;(function($) {
    ...
    $.fn.zoomImage = function(paras) {
		...
		//	console.log( paras.layerW); ==> 100
		//	console.log( paras.layerH); ==> 100
		//	console.log( paras.showPanelW); ==> 500
		//	console.log( paras.showPanelH); ==> 500
		//	console.log( hTimes);==> 5
  //           console.log( wTimes); ==> 5
            // æ”¾å¤§å›¾ç‰‡
